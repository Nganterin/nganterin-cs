...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/ramadiaz/nganterin-cs"><strong>Explore the docs »</strong></a>
    <br />
    <br />
...
1. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/ramadiaz/nganterin-cs.git
   cd nganterin-cs
   ```
...
Project Link: [https://github.com/ramadiaz/nganterin-cs](https://github.com/ramadiaz/nganterin-cs)
